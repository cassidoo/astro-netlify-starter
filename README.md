...
This is an Astro (v0.21.5) starter project based on the [Astro Starter Kit](https://github.com/withastro/astro/tree/main/examples/starter), with a `netlify.toml` configuration included, and an example React component + CSS Module.
